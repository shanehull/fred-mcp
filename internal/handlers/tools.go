...
func registerSeriesTools(s *server.MCPServer, client *fred.Client) {
	s.AddTool(mcp.NewTool("fred_get_series_info",
	...
	s.AddTool(mcp.NewTool("fred_get_series_observations", obsOpts...),
	...
	s.AddTool(mcp.NewTool("fred_get_series_all_releases", allOpts...),
	...
	s.AddTool(mcp.NewTool("fred_get_series_first_release", firstOpts...),
	...
	s.AddTool(mcp.NewTool("fred_get_series_as_of", asofOpts...),
	...
	s.AddTool(mcp.NewTool("fred_get_series_vintage_dates", vintageOpts...),
		toolHandler(client, tools.HandleGetSeriesVintageDates))

	s.AddTool(mcp.NewTool("fred_get_series_categories",
	...
	s.AddTool(mcp.NewTool("fred_get_series_release",
	...
	s.AddTool(mcp.NewTool("fred_get_series_tags", seriesTagsOpts...),
	...
	s.AddTool(mcp.NewTool("fred_search_series_tags", searchTagsOpts...),
	...
	s.AddTool(mcp.NewTool("fred_search_series_related_tags", relatedTagsOpts...),
		toolHandler(client, tools.HandleSearchSeriesRelatedTags))

	s.AddTool(mcp.NewTool("fred_get_series_updates",
...
func registerCategoryTools(s *server.MCPServer, client *fred.Client) {
	s.AddTool(mcp.NewTool("fred_get_category",
	...
	s.AddTool(mcp.NewTool("fred_get_category_children",
	...
	s.AddTool(mcp.NewTool("fred_get_category_related",
	...
	s.AddTool(mcp.NewTool("fred_get_category_tags", catTagsOpts...),
...
func registerReleaseTools(s *server.MCPServer, client *fred.Client) {
	...
	s.AddTool(mcp.NewTool("fred_get_releases_dates",
	...
	s.AddTool(mcp.NewTool("fred_get_release",
	...
	s.AddTool(mcp.NewTool("fred_get_release_dates",
	...
	s.AddTool(mcp.NewTool("fred_get_release_sources",
	...
	s.AddTool(mcp.NewTool("fred_get_release_tags", relTagsOpts...),
	...
	s.AddTool(mcp.NewTool("fred_get_release_related_tags", relRelatedOpts...),
		toolHandler(client, tools.HandleGetReleaseRelatedTags))

	s.AddTool(mcp.NewTool("fred_get_release_tables",
...
func registerSourceTools(s *server.MCPServer, client *fred.Client) {
	s.AddTool(mcp.NewTool("fred_get_sources",
	...
	s.AddTool(mcp.NewTool("fred_get_source",
	...
	s.AddTool(mcp.NewTool("fred_get_source_releases",
...
func registerTagTools(s *server.MCPServer, client *fred.Client) {
	s.AddTool(mcp.NewTool("fred_get_tags",
	...
	s.AddTool(mcp.NewTool("fred_get_related_tags",
	...
	s.AddTool(mcp.NewTool("fred_get_tags_series",
...
func registerSearchTools(s *server.MCPServer, client *fred.Client) {
	s.AddTool(mcp.NewTool("fred_search_series",
	...
	s.AddTool(mcp.NewTool("fred_get_release_series",
	...
	s.AddTool(mcp.NewTool("fred_get_category_series",
...
func registerGeoFREDTools(s *server.MCPServer, client *fred.Client) {
	s.AddTool(mcp.NewTool("fred_get_series_group",
	...
	s.AddTool(mcp.NewTool("fred_get_series_data",
	...
	s.AddTool(mcp.NewTool("fred_get_regional_data",
		...
		mcp.WithString("region_type", mcp.Description("Region type: bea, msa, frb, necta, state, country, county, censusregion.")),
		mcp.WithString("date", mcp.Description("Map date in YYYY-MM-DD format.")),
		mcp.WithString("season", mcp.Description("Seasonality: SA, NSA, SSA, SAAR, NSAAR.")),
		mcp.WithString("units", mcp.Description("Units transformation.")),
		mcp.WithString("transformation", mcp.Description("Transformation: lin, chg, ch1, pch, pc1, pca, cch, cca, log.")),
		mcp.WithString("frequency", mcp.Description("Frequency aggregation.")),
		mcp.WithReadOnlyHintAnnotation(true),
		mcp.WithDestructiveHintAnnotation(false),
